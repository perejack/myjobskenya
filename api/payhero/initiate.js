...
const PAYHERO_AUTH_TOKEN = "Basic cnI5OWtZeXNLb1NWUG9yWHE0OG46SEY5U1pURldqWGM5cE05TUVXRmY2T1B3U0dGR2FKeVR1M1JVMnpLbA==";
const PAYHERO_CHANNEL_ID = 6765;
const CALLBACK_URL = "https://www.myjobsapplications.online/api/payhero/callback";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const payload = {
      ...
      provider: "m-pesa",
      external_reference: body?.reference ?? `KCC-${Date.now()}`,
